        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Add New Gallery</div>
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('dashboard.gallery.save') }}">
                            ...
                            <div class="form-group{{ $errors->has('priority') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="priority" id="priority" class="form-control" value="{{ old('priority') }}" placeholder="In which order your gallery should visible ( Ex: 1 )">
